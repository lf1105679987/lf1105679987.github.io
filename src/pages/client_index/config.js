export const onLine = {
  ...
  context: 'EPIP stands for Epitope Presentation Integrated Prediction. It is a model that leverages peptide PSSM score, expression level and length to predict whether a peptide can be presented on the cell surface by MHC-I, which is a crucial step for activating CD8+ T-cell. The model is trained using more than 180,000 peptides identified by mass spectrometry (MS), and with the help of expression data, it can lead to a more accurate presentation prediction. To learn more information, please check our preprint paper here(<a href="https://www.biorxiv.org/content/10.1101/567081v1" target="_blank">https://www.biorxiv.org/content/10.1101/567081v1</a>). The source code of EPIP is available at <a href="https://github.com/BGI2016/EPIP" target="_blank">https://github.com/BGI2016/EPIP</a>.</br>Corresponding email: <a href="javascript:;">P_genoimmune@genomics.cn</a>.</br>&nbsp;&nbsp;&nbsp;&nbsp;NOTICE: You can use the public account to test the function of EPIP online without registering, but your submission history that includes the data and results are exposed to other users who also use the public account.</br>&nbsp;&nbsp;&nbsp;&nbsp;Public account: tmp_user, Password: tmp_pw'
};
...
export const help = {
  ...
  table_list: [
    {
      label: 'Training data',
      download: 'https://github.com/BGI2016/EPIP/tree/master/epip/training_dataset'
    },
    {
      label: 'Test data',
      download: 'https://github.com/BGI2016/EPIP/tree/master/epip/test_dataset'
    }
  ]
};
